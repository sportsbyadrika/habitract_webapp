...
<div class="bg-white rounded-xl shadow-xl w-full max-w-lg p-6">
    ...
    <form method="post"
        ...
        <!-- Submit -->
        <button type="submit"
                class="w-full bg-gradient-to-r from-blue-600 to-slate-600 hover:bg-gradient-to-r from-blue-600 to-slate-600 text-white font-semibold py-3 rounded-lg shadow-md transition">
            Send OTP & Continue
        </button>
    </form>
